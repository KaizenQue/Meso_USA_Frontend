...
const MesotheliomaLandingPageLatest16 = () => {
...
<<<<<<< HEAD
                            Maintenance Mechanics Diagnosed with Mesothelioma
                        </h1>
                        <p className="max-w-xl text-sm sm:text-base text-gray-200">
                            Fixing pipes, ducts, and machinery in older buildings put many at risk. If you're facing a diagnosis, legal help is here.
=======
                        Maintenance Mechanics Diagnosed with Mesothelioma
                        </h1>
                        <p className="max-w-xl text-sm sm:text-base text-gray-200">
...
<<<<<<< HEAD
                                High-Risk Exposure Components for Maintenance Mechanics
                            </h3>
...
export default MesotheliomaLandingPageLatest16;