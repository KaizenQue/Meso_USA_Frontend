...
const MesotheliomaLandingPageLatest12 = () => {
...
<<<<<<< HEAD
                            Boilermakers Diagnosed with Mesothelioma
                        </h1>
                        <p className="max-w-xl text-sm sm:text-base text-gray-200">
                            Boilermakers worked in confined spaces with asbestos-coated boilers and insulation. If you’ve received a mesothelioma diagnosis, compensation may be available
=======
                        Boilermakers Diagnosed with Mesothelioma
                        </h1>
                        <p className="max-w-xl text-sm sm:text-base text-gray-200">
...
<<<<<<< HEAD
                                High-Risk Exposure Components for Boilermakers
                            </h3>
...
export default MesotheliomaLandingPageLatest12;