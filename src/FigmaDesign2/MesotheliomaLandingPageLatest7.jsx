...
import Img from "../assets/CCN7.jpg";
...
const MesotheliomaLandingPageLatest7 = () => {
...
<<<<<<< HEAD
                            Paper Mill Workers Diagnosed with Mesothelioma
                        </h1>
                        <p className="max-w-xl text-sm sm:text-base text-gray-200">
                            Paper mills used asbestos for insulation in dryers, digesters, and steam systems. If you've been diagnosed with mesothelioma, your work history may support a legal claim.
=======
                        Paper Mill Workers Diagnosed with Mesothelioma 
                        </h1>
                        <p className="max-w-xl text-sm sm:text-base text-gray-200">
...
<<<<<<< HEAD
                                Paper Mill Roles with High Asbestos Risk
                            </h3>
                            <p className="mt-3 text-sm sm:text-base text-gray-200">
                                Diagnosed with mesothelioma after working in a paper mill? You may have been exposed to asbestos in insulation or equipment. Our legal team can help you build a case.
=======
                                Paper Mill Roles with High Asbestos Risk 
                            </h3>
                            <p className="mt-3 text-sm sm:text-base text-gray-200">
...
export default MesotheliomaLandingPageLatest7;