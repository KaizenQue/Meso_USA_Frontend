...
import Img from "../assets/CCN5.jpg";
import ImgSvg1 from '../assets/CCN51.svg';
import ImgSvg2 from '../assets/CCN52.svg';
import ImgSvg3 from '../assets/CCN53.svg';
import ImgSvg4 from '../assets/CCN54.svg';
import ImgSvg5 from '../assets/CCN55.svg';
import ImgSvg6 from '../assets/CCN56.svg';
...
const MesotheliomaLandingPageLatest5 = () => {
...
<<<<<<< HEAD
                            Steel Mill Workers Diagnosed with Mesothelioma
                        </h1>
                        <p className="max-w-xl text-sm sm:text-base text-gray-200">
                            If you worked in a steel plant and developed mesothelioma, asbestos insulation, refractory bricks, and pipe coatings may have been the cause. Legal support is available now.
=======
                        Steel Mill Workers Diagnosed with Mesothelioma 
                        </h1>
                        <p className="max-w-xl text-sm sm:text-base text-gray-200">
...
<<<<<<< HEAD
                                Steel Mill Roles with High Asbestos Risk
                            </h3>
                            <p className="mt-3 text-sm sm:text-base text-gray-200">
                                Diagnosed with mesothelioma after working in steel manufacturing? You may qualify for compensation. Our team will help assess your exposure and pursue your case.
=======
                                Steel Mill Roles with High Asbestos Risk 
                            </h3>
                            <p className="mt-3 text-sm sm:text-base text-gray-200">
...
export default MesotheliomaLandingPageLatest5;