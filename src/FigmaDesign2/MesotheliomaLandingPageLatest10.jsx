...
const MesotheliomaLandingPageLatest10 = () => {
...
<<<<<<< HEAD
                        ...
                        <p className="max-w-xl text-sm sm:text-base text-gray-200">
                            Asbestos-coated pipes and valve wraps were common in your trade. If you’re facing a mesothelioma diagnosis, legal help is available now.
=======
                        Pipefitters and Steamfitters Diagnosed with Mesothelioma
                        </h1>
                        <p className="max-w-xl text-sm sm:text-base text-gray-200">
...
<<<<<<< HEAD
                                High-Risk Exposure Components for Pipefitters
                            </h3>
...
export default MesotheliomaLandingPageLatest10;