...
const MesotheliomaLandingPageNew = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.humanVerification) {
      tempErrors.humanVerification =
        "Please check this box to verify you are a person before proceeding.";
      isValid = false;
    }
        ...
        <div className="relative md:absolute md:right-0 md:top-[8%] w-full md:w-2/5 z-20 mt-8 mb-8 md:mt-0">
          <div className="bg-white rounded-lg shadow-lg mx-6 sm:mx-8 md:mx-12 lg:mx-16">
            <div className="p-6 sm:p-8 relative overflow-hidden">
              <div
                className={`transition-all duration-300 ease-in-out transform ${formSubmitted
                  ...
                  <div className="flex flex-col items-center justify-center min-h-[340px]">
                    ...
                    <div className="text-left w-full px-2">
                      ...
                      <p className="text-gray-600 text-base sm:text-lg mb-8">
                        Even if you're not certain about your asbestos exposure,
                        our legal experts can help you find out. Don't wait—your
                        health and your future could depend on it. Speak with us
                        today.
                      </p>
                      <div className="text-center mb-6">
                        ...
                        />
                        <h3 className="text-2xl sm:text-3xl font-bold text-[#4B2C5E] mb-3">
                          Call Us Now
                        </h3>
                      </div>
                      <a
                      ...
                      >
                        ...
                        <style jsx>{`
                          ...
                          .playbtn:hover {
                            background: #b38a5c;
                            color: #ffffff;
                            box-shadow: 0 0 5px #c49a6c, 0 0 25px #c49a6c,
                              0 0 50px #c49a6c, 0 0 200px #c49a6c;
                          }
                    ...
                    >
                      ...
                      <div className="space-y-2 sm:space-y-3">
                        ...
                        <input
                          ...
                          className={`w-full bg-white border ${errors.fullName
                            ? "border-red-500"
                            : "border-gray-300"
                            } rounded-md p-3 text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm sm:text-base`}
                        />
                        {errors.fullName && (
                        ...
                        <div className="flex">
                          ...
                          <input
                            ...
                            className={`w-full bg-white border ${errors.phone
                              ? "border-red-500"
                              : "border-gray-300"
                              } rounded-r-md p-3 text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm sm:text-base`}
                          />
                        </div>
                        {errors.phone && (
                          <p className="text-red-500 text-sm mt-1">
                      ...
                      {/* <Turnstile
                        ...
                        sitekey="0x4AAAAAABfAlFRdUfzeAp3-"
                        onSuccess={setToken}
                      /> */}
                      <button
                        type="submit"
