...
import Img from "../assets/CCN8.jpg";
...
const MesotheliomaLandingPageLatest8 = () => {
                ...
                <div className="relative z-10 flex h-full flex-col p-6 sm:p-8 md:p-12 lg:p-16">
                    ...
                    <div className="space-y-4 sm:space-y-6 md:max-w-[55%] pt-24 md:pt-0 md:mt-32">
                        ...
                        <h1 className="text-2xl sm:text-3xl font-bold text-white md:text-4xl lg:text-5xl">
                            Heavy Manufacturing Workers Diagnosed with Mesothelioma
                        </h1>
                    ...
                    <div className="space-y-6 sm:space-y-8">
                        <div>
                            <h3 className="text-lg sm:text-xl font-bold text-white md:text-2xl">
                                Manufacturing Roles with High Asbestos Risk
                            </h3>
                            <p className="mt-3 text-sm sm:text-base text-gray-200">
                                Diagnosed with mesothelioma after working in manufacturing? Our legal team can help trace your exposure and guide you through your legal options.
                            </p>
                        </div>
...
export default MesotheliomaLandingPageLatest8;