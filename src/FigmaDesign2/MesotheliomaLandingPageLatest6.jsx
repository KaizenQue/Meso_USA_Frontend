...
import Img from "../assets/CCN6.jpg";
import ImgSvg1 from '../assets/CCN61.svg';
import ImgSvg2 from '../assets/CCN62.svg';
import ImgSvg3 from '../assets/CCN63.svg';
import ImgSvg4 from '../assets/CCN64.svg';
import ImgSvg5 from '../assets/CCN65.svg';
import ImgSvg6 from '../assets/CCN66.svg';
...
const MesotheliomaLandingPageLatest6 = () => {
                ...
                <div className="relative z-10 flex h-full flex-col p-6 sm:p-8 md:p-12 lg:p-16">
                    ...
                    <div className="space-y-4 sm:space-y-6 md:max-w-[55%] pt-24 md:pt-0 md:mt-32">
                        ...
                        <h1 className="text-2xl sm:text-3xl font-bold text-white md:text-4xl lg:text-5xl">
                            Refinery Workers Diagnosed with Mesothelioma
                        </h1>
                        <p className="max-w-xl text-sm sm:text-base text-gray-200">
                            Asbestos was used extensively in refineries to insulate piping, pumps, and furnaces. If you were diagnosed with mesothelioma after working in refining, we can help you take legal action.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="space-y-6 sm:space-y-8">
                        <div>
                            <h3 className="text-lg sm:text-xl font-bold text-white md:text-2xl">
                                Refinery Roles with High Asbestos Risk
                            </h3>
                            <p className="mt-3 text-sm sm:text-base text-gray-200">
                                Diagnosed with mesothelioma after refinery work? From insulators to valve mechanics, many roles carried hidden asbestos risks. Let us help you investigate and file a claim.
                            </p>
                        </div>
...
export default MesotheliomaLandingPageLatest6;