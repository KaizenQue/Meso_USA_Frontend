...
import Img from "../assets/CCN4.jpg";
import ImgSvg1 from '../assets/CCN41.svg';
import ImgSvg2 from '../assets/CCN42.svg';
import ImgSvg3 from '../assets/CCN43.svg';
import ImgSvg4 from '../assets/CCN44.svg';
import ImgSvg5 from '../assets/CCN45.svg';
import ImgSvg6 from '../assets/CCN46.svg';
...
const MesotheliomaLandingPageLatest4 = () => {
        ...
        <div className="flex min-h-screen flex-col">
          ...
          <div className="py-2 sm:px-6 sm:py-3 text-white w-46 sm:w-58 text-left text-sm sm:text-base mb-8">
                    ...
                    <div className="space-y-4 sm:space-y-6 md:max-w-[55%] pt-24 md:pt-0 md:mt-32">
                        ...
                        Power Plant Workers Diagnosed with Mesothelioma 
                        </h1>
                        <p className="max-w-xl text-sm sm:text-base text-gray-200">
                        If you worked in a power plant and were diagnosed with mesothelioma, asbestos insulation around turbines, boilers, and pipes may be the cause. We help workers understand their legal options and seek rightful compensation.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="space-y-6 sm:space-y-8">
                        <div>
                            <h3 className="text-lg sm:text-xl font-bold text-white md:text-2xl">
                                Power Plant Roles with High Asbestos Risk 
                            </h3>
                            <p className="mt-3 text-sm sm:text-base text-gray-200">
                            Diagnosed with mesothelioma after working in a power plant? You may have been exposed to asbestos in high-heat equipment. Our legal team is here to help you take action
                            </p>
                        </div>
...
export default MesotheliomaLandingPageLatest4;