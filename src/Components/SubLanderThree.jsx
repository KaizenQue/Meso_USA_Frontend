        ...
        >
          <Grid container spacing={4} className="min-h-screen">
                ...
                >
                  {[
                    ...
                    <Box key={index} className="flex items-center gap-3">
                      ...
                      <Typography className="text-[#161616] font-georgia leading-tight font-normal">
                        {text}
                      </Typography>
                    </Box>
                  ))}
            ...
            <Grid item xs={12} md={6}>
              <motion.h1
                className="text-[#2E4A7D] font-georgia font-normal leading-tight text-left mx-auto px-4 xl:mt-32 lg:w-[1600px]"
                style={{
