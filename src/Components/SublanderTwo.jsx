        ...
        >
          <Grid container spacing={4} className="min-h-screen">
            ...
            <Grid item xs={12} md={6} mt={5}>
              ...
              >
                <motion.p
                  className="text-[#000000]-600 font-georgia font-normal leading-tight text-left mx-auto text-[21px]"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                ...
                <motion.p>
                  <b className="text-[#2E4A7D] font-georgia font-bold leading-tight">
                ...
                >
                  {[
                    ...
                    <Box key={index} className="flex items-center gap-3 font-georgia font-normal leading-tight">
                      <Box className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-primary font-georgia font-normal  leading-tight">
                        <svg
                      ...
                      <Typography className="text-[#000000]-600 font-georgia font-normal leading-tight">
                        {text}
                      </Typography>
                    </Box>
                  ))}
