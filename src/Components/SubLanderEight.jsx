          ...
          <Grid container spacing={4} className="min-h-screen">
            ...
            <Grid item xs={12} md={6} mt={5}>
              ...
              >
                ...
                <motion.p>
                  <b className="text-[#6b6b6b] font-georgia font-normal leading-tight text-left mx-auto text-[21px]">
                ...
                >
                  {[
                    ...
                    >
                      ...
                      <Typography style={{ fontFamily: 'Georgia, serif' }} className="text-[#6b6b6b] font-georgia font-normal leading-tight text-[32px]">
                        {text}
                      </Typography>
                    </Box>
                  ))}
