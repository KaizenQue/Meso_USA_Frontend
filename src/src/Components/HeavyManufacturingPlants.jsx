            ...
            <Grid item xs={12} md={6} className="2xl:flex 2xl:justify-center">
              ...
              >
                ...
                >
                  ...
                  >
                    If mesothelioma followed your years in manufacturing, it’s
                    time to explore your right to compensation. Many workers
                    were unknowingly exposed to asbestos through:
                  </motion.p>
                  ...
                  >
                    {[
                      ...
                      "Pipe insulation and gasket materials used in daily operations",
                      "Mechanical components like pumps, valves, and motors",
                    ].map((text, index) => (
                      <Box
                        key={index}
                  ...
                  >
                    ...
                    >
                      <CardContent>
                        ...
                        >
                          You may be entitled to compensation. We’re here to help.
                        </Typography>
                      </CardContent>
                    </Card>
                  </motion.div>
