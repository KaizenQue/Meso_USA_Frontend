...
export default function MesoAutoMobile() {
  ...
  const validateForm = () => {
    ...
    if (formData.firstName && !nameRegex.test(formData.firstName)) {
      newErrors.firstName =
        "First name should only contain letters, spaces, hyphens, apostrophes, and periods";
    }
    if (formData.lastName && !nameRegex.test(formData.lastName)) {
      newErrors.lastName =
        "Last name should only contain letters, spaces, hyphens, apostrophes, and periods";
    }
  ...
  return (
    <Box className="relative min-h-screen w-full overflow-hidden">
      ...
      <Box className="relative z-10 min-h-screen w-full flex justify-center">
        <Container
          maxWidth="xl"
          className="relative mx-auto min-h-screen 2xl:max-w-[1920px]"
        >
          {/* Logo */}
          ...
          <Grid
            container
            spacing={4}
            className="min-h-screen pt-16 2xl:pt-24 2xl:max-w-[1600px] 2xl:mx-auto"
          >
            {/* Left Side - Content */}
            <Grid item xs={12} md={6} className="2xl:flex 2xl:justify-center">
              ...
              >
                ...
                >
                  ...
                  >
                    If you worked in auto manufacturing, repair, or maintenance
                    and have been diagnosed with mesothelioma, you are not alone
                    and you may be eligible for compensation. This includes
                    high-risk roles such as:
                  </motion.p>
                      ...
                      <ListItem>
                        ...
                        <Typography>
                          <Typography
                            ...
                            sx={{ fontWeight: "bold" }}
                          >
                            Brake specialists, mechanics, and clutch repair technicians
                          </Typography>{" "}
                          {/* - Brake Specialists, Mechanics, Clutch Repair
                          Technicians */}
                        </Typography>
                      </ListItem>
                      <ListItem>
                        ...
                        <Typography>
                          <Typography
                            ...
                            sx={{ fontWeight: "bold" }}
                          >
                            Automotive Assembly Line Workers, Parts Fabricators,
                      ...
                      <ListItem>
                        ...
                        <Typography>
                          <Typography
                            ...
                            sx={{ fontWeight: "bold" }}
                          >
                            Auto Body Technicians, Paint Shop Workers, Heavy
                  ...
                  >
                    ...
                    >
                      <CardContent>
                        ...
                        >
                          You served your country with honor. Now it's time to
                          protect your rights. Help is available
                        </Typography>
                      </CardContent>
                    </Card>
                  </motion.div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="text-xs sm:text-sm font-['Helvetica'] ">
                          <span className="block">
                            ...
                            affiliates and/or lawyer to contact me at the number
                            provided above, even if this number is a wireless
                            number or if I am presently listed on a "Do Not
                            Call" list. I understand that I may be contacted by
                    ...
                    <div className="text-left sm:text-left">
                      <button
                        ...
                        className={`rounded-[10px] bg-[#4b2c5e] text-[#f8f2e9] px-8 sm:px-12 py-3 sm:py-4 2xl:py-5 2xl:px-16 font-bold transition-colors text-sm sm:text-base md:text-lg 2xl:text-xl flex items-center justify-center gap-2 ${isSubmitting
