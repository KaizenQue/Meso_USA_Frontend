        ...
        <div className="w-full lg:w-3/5 text-white pl-4 lg:pl-4 pr-6 lg:pr-12 flex flex-col items-start">
          ...
          <div className="mt-24 sm:mt-28 lg:mt-12 max-w-xl">
            <h1 className="text-4xl lg:text-5xl font-bold leading-tight">
              Diagnosed with Mesothelioma from the Automotive Industry?
            </h1>
            <p className="mt-4 text-sm lg:text-base">
              If you worked in auto manufacturing, repair, or maintenance and
              now facing mesothelioma, you are not alone and you may be eligible
              for compensation.
            </p>
          </div>
          ...
          <div className="mt-24 flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs mt-1">
                  Brake Specialists, Mechanics, Clutch Repair Technicians
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs mt-1">
                  Auto Body Technicians, Paint Shop Workers, Heavy Equipment
                  Technicians
                </p>
              </div>
            </div>
