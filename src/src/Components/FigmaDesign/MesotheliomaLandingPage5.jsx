        ...
        <div className="w-full lg:w-3/5 text-white pl-4 lg:pl-4 pr-6 lg:pr-12 flex flex-col items-start">
          ...
          <div className="mt-24 sm:mt-28 lg:mt-12 max-w-xl">
            ...
            <p className="mt-4 text-sm lg:text-base">
              If you worked in construction and have now been diagnosed with
              Mesothelioma, you're not alone, and you may be eligible for
              compensation.
            </p>
          </div>
          ...
          <div className="mt-24 flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">
                  Renovation Contractors, Bricklayers, <br></br> and Masons
                </h3>
                <p className="text-xs mt-1">
                  {/* Renovation Contractors, Bricklayers, and Masons */}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">
                  Sheet Metal Workers, Insulation Installers, <br></br>{" "}
                  Construction Laborers
                </h3>
                <p className="text-xs mt-1">
                  {/* Sheet Metal Workers, Insulation Installers, Construction
                  Laborers */}
                </p>
              </div>
            </div>
