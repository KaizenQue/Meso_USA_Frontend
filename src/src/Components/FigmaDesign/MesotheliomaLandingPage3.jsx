        ...
        <div className="w-full lg:w-3/5 text-white pl-4 lg:pl-4 pr-6 lg:pr-12 flex flex-col items-start">
          ...
          <div className="mt-24 sm:mt-28 lg:mt-12 max-w-xl">
            ...
            <p className="mt-4 text-sm lg:text-base">
              Steel mill work was essential to American industry but for many,
              it came with hidden dangers. If you worked in a steel mill and
              diagnosed with mesothelioma, you may be entitled to significant
              compensation.
            </p>
          </div>
          ...
          <div className="mt-8 text-sm lg:text-base">
            <p>
              ...
              exposure and have helped former steelworkers win.
            </p>
          </div>
