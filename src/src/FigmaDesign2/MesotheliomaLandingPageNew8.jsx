...
import ImgMobile from "../assets/MesoFD21Mobile.png"
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        window.location.href = "tel:+18882128149";
      }
    } catch (error) {
      ...
      <div className="relative min-h-[100vh] md:h-[70vh]">
        <div className="absolute inset-0 bg-black/50">
          <div
            ...
            style={{
              backgroundImage: `url(${isMobile ? ImgMobile : Img})`,
                ...
                <div>
                  <div className="text-xs sm:text-sm font-['Helvetica'] text-gray-700 flex items-start gap-3">
                    <input
                      ...
                      onChange={handleChange}
                      className="mt-1 w-6 h-6 min-w-[24px] min-h-[24px] flex-shrink-0"
                    />
...
export default MesotheliomaLandingPageNew8;